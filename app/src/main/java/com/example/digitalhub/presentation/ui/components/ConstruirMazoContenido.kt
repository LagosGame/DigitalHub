            ...
            Row(
                ...
                Box(
                    ...
                    BotonesDentro(
                        ...
                        modifier = Modifier.height(120.dp).width(180.dp),
                        isEnabled = true,
                        onClick = onCrearMazo
                    )
                }
                                    ...
                                    BoxInfoCarta(colorCarta = colorMazo) {
                                        Column(
                                            modifier = Modifier.fillMaxWidth()
                                                .clickable { onMazoClick(mazo.id) }.padding(12.dp),
                                            verticalArrangement = Arrangement.spacedBy(12.dp)
                                        ) {
                                            Row(
                                                ...
                                                Row(
                                                    ...
                                                    Icon(
                                                        ...
                                                        tint = if (mazo.cartasNormales == 50 && mazo.cartasHuevo == 4 || mazo.cartasHuevo == 5) Color(
                                                            0xFF1B5E20
                                            ...
                                            if (mazoAEliminar != null) {
                                                val mazoEncontrado =
                                                    uiState.mazos.find { it.id == mazoAEliminar }
                                                if (mazoEncontrado != null) {
                                                    val cartasDelMazo =
                                                        uiState.todasLasCartas?.filter { carta ->
                                                            mazoEncontrado.cartas.any { it.cartaId == carta.id }
                                                        } ?: emptyList()
                                                    DialogoEliminarMazo(
                                                        mazo = mazoEncontrado,
                                            ...
                                            if (mazo.tags.isNotEmpty()) {
                                                Row(
                                                    ...
                                                    mazo.tags.forEach { tag -> TagsDeck(tag) }
                                                }
                                            }
                                        }
                                    }
